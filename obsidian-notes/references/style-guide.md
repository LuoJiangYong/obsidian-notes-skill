...
- 网页 URL 使用 Markdown 链接格式，确保在 Obsidian 中可点击，例如 `[微信原文](https://mp.weixin.qq.com/...)`。不要写成反引号代码格式。
...
- 网页、微信、在线文档、官方文档等 URL 写成 Markdown 链接：`[来源名称](https://...)`。
- 链接文字要短而明确，例如 `[微信原文](...)`、`[官方文档](...)`、`[腾讯文档](...)`。
